    ...
    public static function defaultStatuses(): array
    {
        return [
            ...
            'ordre_mission_ligne' => self::rows([
                ['planifie', 'Planifié', 0, true, false, 'amber'],
                ['en_cours', 'En cours', 10, false, false, 'orange'],
                ['freeze', 'Freeze', 20, false, false, 'violet'],
                ['attente_validation', 'Attente validation', 30, false, false, 'teal'],
                ['cloture', 'Clôturé', 40, false, true, 'emerald'],
                ['annule', 'Annulé', 50, false, true, 'red'],
            ]),
            'mission_task' => self::rows([
                ['todo', 'Planifié', 0, true, false, 'amber'],
                ['in_progress', 'En cours', 10, false, false, 'orange'],
                ['paused', 'En cours', 20, false, false, 'orange'],
                ['frozen', 'Freeze', 30, false, false, 'violet'],
                ['done', 'Attente validation', 40, false, false, 'teal'],
                ['validated', 'Clôturé', 50, false, true, 'emerald'],
                ['rejected', 'Annulé', 60, false, true, 'red'],
            ]),
