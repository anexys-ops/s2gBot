...
<body>
    ...
    <div class="totals">
        ...
        <p>Remise document : {{ number_format($quote->discount_percent, 2, ',', ' ') }} % @if((float)$quote->discount_amount > 0) + {{ number_format($quote->discount_amount, 2, ',', ' ') }} € HT @endif</p>
        @endif
        @if((float)$quote->shipping_amount_ht > 0)
        <p>Frais de port / livraison HT : {{ number_format($quote->shipping_amount_ht, 2, ',', ' ') }} € (TVA {{ number_format($quote->shipping_tva_rate, 2, ',', ' ') }} %)</p>
        @endif
        <p><strong>Total HT :</strong> {{ number_format($quote->amount_ht, 2, ',', ' ') }} €</p>
        <p><strong>Total TTC :</strong> {{ number_format($quote->amount_ttc, 2, ',', ' ') }} €</p>
    </div>
